...
const syncFromLocalStorage = (initState?: Init) => {
...
const syncToLocalStorage = (updatedState: Storage) => {
...
watch(state, (updatedState: Storage) => syncToLocalStorage(updatedState), { deep: true })
